...
#Heuristic 4 will keep the backrow full until necessary
            ...
            if backRowChecks != False:
                ...
                #print(backRowChecks, "backRowChecks")
...
#Heristic 2: will move checker piece into a open edge
            ...
            #print (sideOpen)
            if sideOpen != False:
                #print("side open fine")
                return sideOpen
            
#Heristic 12: this will take a random item in the lst if nothing else has been selected
...
#Heristic 12: take a random item in list if no other move has been taken   
